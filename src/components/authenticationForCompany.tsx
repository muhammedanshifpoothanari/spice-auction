...
import { CompanyLogin, CreateUser, UserLogin } from "@/lib/actions/login"
...
if(!response.error) { 
  ...
  return (
    ...
    <div className="space-y-2 text-center">
      ...
      <p className="text-gray-500 dark:text-gray-400">Enter your companyName below to login to your account</p>
    </div>
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="companyName">companyName</Label>
        <Input id="companyName" placeholder="company name" required type="companyName" onChange={e => setCompanyName(e.target.value)} />
      </div>
      <div className="space-y-2">
...
account</p>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="companyName">companyName</Label>
        <Input id="companyName" placeholder="m@example.com" required type="companyName" onChange={e => setCompanyName(e.target.value)}/>
      </div>
      <div className="space-y-2">
